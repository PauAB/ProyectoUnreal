...
ACube_C__pf199495785::ACube_C__pf199495785(const FObjectInitializer& ObjectInitializer) : Super()
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ACube_C__pf199495785::StaticClass() == GetClass()))
	{
		ACube_C__pf199495785::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
	auto& __Local__0 = (*(AccessPrivateProperty<float >((bpv__Sphere__pf), USphereComponent::__PPO__SphereRadius() )));
	__Local__0 = 40.000000f;
	bpv__Sphere__pf->RelativeScale3D = FVector(2.500000, 2.500000, 2.500000);
	...
	__Local__3 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ACube_C__pf199495785::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__StaticMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__StaticMesh__pf->OverrideMaterials.Reserve(1);
	bpv__StaticMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ACube_C__pf199495785::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__StaticMesh__pf->bRenderCustomDepth = true;
...
TEXT("NSLOCTEXT(\"[4FB969D4405F1E6D677B4BBB0F2018D6]\", \"B9048BDC4439AC209B3938890F899A6E\", \"Ice Cube\")")	);
	bpv__ItemStruct__pf.bpv__Texture_15_7F6B4FA54855A03EC62974BC9E749329__pf = CastChecked<UTexture2D>(CastChecked<UDynamicClass>(ACube_C__pf199495785::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	bpv__ItemStruct__pf.bpv__MaxStackSize_10_24C692A64198F66E71A52199D20FB35C__pf = 5;
	bpv__ItemStruct__pf.bpv__Class_12_33456D674F08300E4B2C238A1C0A44C6__pf = GetClass();
}
PRAGMA_ENABLE_OPTIMIZATION
void ACube_C__pf199495785::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void ACube_C__pf199495785::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ACube_C__pf199495785::bpf__ExecuteUbergraph_Cube__pf_0(int32 bpp__EntryPoint__pf)
{
...
void ACube_C__pf199495785::bpf__DestroyItem__pf()
{
	bpf__ExecuteUbergraph_Cube__pf_0(2);
}
PRAGMA_DISABLE_OPTIMIZATION
void ACube_C__pf199495785::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ACube_C__pf199495785::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ACube_C__pf199495785
{
	FRegisterHelper__ACube_C__pf199495785()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/TopDownBP/Blueprints/InventoryLogic/Selectable/Cube"), &ACube_C__pf199495785::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ACube_C__pf199495785 Instance;
};
FRegisterHelper__ACube_C__pf199495785 FRegisterHelper__ACube_C__pf199495785::Instance;
