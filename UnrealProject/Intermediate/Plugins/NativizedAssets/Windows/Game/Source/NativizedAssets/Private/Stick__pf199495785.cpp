...
AStick_C__pf199495785::AStick_C__pf199495785(const FObjectInitializer& ObjectInitializer) : Super()
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (AStick_C__pf199495785::StaticClass() == GetClass()))
	{
		AStick_C__pf199495785::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
	auto& __Local__0 = (*(AccessPrivateProperty<float >((bpv__Sphere__pf), USphereComponent::__PPO__SphereRadius() )));
	__Local__0 = 40.000000f;
	...
	auto& __Local__3 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__StaticMesh__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__3 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AStick_C__pf199495785::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__StaticMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__StaticMesh__pf->OverrideMaterials.Reserve(1);
	bpv__StaticMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AStick_C__pf199495785::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__StaticMesh__pf->RelativeLocation = FVector(-80.000000, 0.000000, 0.000000);
	bpv__StaticMesh__pf->RelativeScale3D = FVector(1.000000, 1.000000, 0.500000);
	(((UBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__StaticMesh__pf), true, 0));
	bpv__ItemStruct__pf.bpv__Name_6_B6AB9EB541573009E7015587D2D24A4C__pf = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[1350080441B8AB0F2DC915B7F4C6F65A]\", \"1D07523E4EA442C2DB0219BCE3357BED\", \"Stick\")")	);
	bpv__ItemStruct__pf.bpv__Texture_15_7F6B4FA54855A03EC62974BC9E749329__pf = CastChecked<UTexture2D>(CastChecked<UDynamicClass>(AStick_C__pf199495785::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	bpv__ItemStruct__pf.bpv__MaxStackSize_10_24C692A64198F66E71A52199D20FB35C__pf = 2;
	bpv__ItemStruct__pf.bpv__Class_12_33456D674F08300E4B2C238A1C0A44C6__pf = GetClass();
}
PRAGMA_ENABLE_OPTIMIZATION
void AStick_C__pf199495785::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void AStick_C__pf199495785::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void AStick_C__pf199495785::bpf__ExecuteUbergraph_Stick__pf_0(int32 bpp__EntryPoint__pf)
{
...
void AStick_C__pf199495785::bpf__DestroyItem__pf()
{
	bpf__ExecuteUbergraph_Stick__pf_0(2);
}
PRAGMA_DISABLE_OPTIMIZATION
void AStick_C__pf199495785::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AStick_C__pf199495785::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{68, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/TopDownBP/Blueprints/InventoryLogic/Selectable/Item.Item_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AStick_C__pf199495785
{
	FRegisterHelper__AStick_C__pf199495785()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/TopDownBP/Blueprints/InventoryLogic/Selectable/Stick"), &AStick_C__pf199495785::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AStick_C__pf199495785 Instance;
};
FRegisterHelper__AStick_C__pf199495785 FRegisterHelper__AStick_C__pf199495785::Instance;
