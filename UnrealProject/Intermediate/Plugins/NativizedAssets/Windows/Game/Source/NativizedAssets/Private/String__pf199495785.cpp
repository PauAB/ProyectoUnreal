...
AString_C__pf199495785::AString_C__pf199495785(const FObjectInitializer& ObjectInitializer) : Super()
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (AString_C__pf199495785::StaticClass() == GetClass()))
	{
		AString_C__pf199495785::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	__Local__3 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AString_C__pf199495785::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__StaticMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__StaticMesh__pf->OverrideMaterials.Reserve(1);
	bpv__StaticMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AString_C__pf199495785::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
...
TEXT("NSLOCTEXT(\"[F714B5D6402F80222F8F188BBC31A422]\", \"653A21CE4BD0F20BE2EA36B17B068B5E\", \"String\")")	);
	bpv__ItemStruct__pf.bpv__Texture_15_7F6B4FA54855A03EC62974BC9E749329__pf = CastChecked<UTexture2D>(CastChecked<UDynamicClass>(AString_C__pf199495785::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	bpv__ItemStruct__pf.bpv__MaxStackSize_10_24C692A64198F66E71A52199D20FB35C__pf = 3;
	bpv__ItemStruct__pf.bpv__Class_12_33456D674F08300E4B2C238A1C0A44C6__pf = GetClass();
}
PRAGMA_ENABLE_OPTIMIZATION
void AString_C__pf199495785::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void AString_C__pf199495785::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void AString_C__pf199495785::bpf__ExecuteUbergraph_String__pf_0(int32 bpp__EntryPoint__pf)
{
...
void AString_C__pf199495785::bpf__DestroyItem__pf()
{
	bpf__ExecuteUbergraph_String__pf_0(2);
}
PRAGMA_DISABLE_OPTIMIZATION
void AString_C__pf199495785::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AString_C__pf199495785::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AString_C__pf199495785
{
	FRegisterHelper__AString_C__pf199495785()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/TopDownBP/Blueprints/InventoryLogic/Selectable/String"), &AString_C__pf199495785::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AString_C__pf199495785 Instance;
};
FRegisterHelper__AString_C__pf199495785 FRegisterHelper__AString_C__pf199495785::Instance;
