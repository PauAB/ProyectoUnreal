...
ABuild_C__pf1097354743::ABuild_C__pf1097354743(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ABuild_C__pf1097354743::StaticClass() == GetClass()))
	{
		ABuild_C__pf1097354743::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	bpv__Box__pf->RelativeScale3D = FVector(8.000000, 8.000000, 1.000000);
	bpv__Box__pf->bHiddenInGame = false;
...
void ABuild_C__pf1097354743::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABuild_C__pf1097354743::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ABuild_C__pf1097354743::bpf__ExecuteUbergraph_Build__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 1);
	return; // KCST_GotoReturn
}
void ABuild_C__pf1097354743::bpf__Interact__pf(AActor* bpp__Interactor__pf)
{
	b0l__K2Node_Event_Interactor__pf = bpp__Interactor__pf;
	bpf__ExecuteUbergraph_Build__pf_0(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABuild_C__pf1097354743::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABuild_C__pf1097354743::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABuild_C__pf1097354743
{
	FRegisterHelper__ABuild_C__pf1097354743()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/TopDownBP/Blueprints/InventoryLogic/Builds/Build"), &ABuild_C__pf1097354743::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABuild_C__pf1097354743 Instance;
};
FRegisterHelper__ABuild_C__pf1097354743 FRegisterHelper__ABuild_C__pf1097354743::Instance;
