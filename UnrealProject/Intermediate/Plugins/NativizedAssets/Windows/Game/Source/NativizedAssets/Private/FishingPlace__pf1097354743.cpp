...
AFishingPlace_C__pf1097354743::AFishingPlace_C__pf1097354743(const FObjectInitializer& ObjectInitializer) : Super()
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (AFishingPlace_C__pf1097354743::StaticClass() == GetClass()))
	{
		AFishingPlace_C__pf1097354743::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	
	bpv__Box__pf->RelativeLocation = FVector(0.000000, 110.000000, 0.000000);
	bpv__Box__pf->RelativeScale3D = FVector(10.000000, 6.000000, 1.000000);
	...
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AFishingPlace_C__pf1097354743::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__StaticMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__StaticMesh__pf->OverrideMaterials.Reserve(1);
	bpv__StaticMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AFishingPlace_C__pf1097354743::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__StaticMesh__pf->RelativeLocation = FVector(80.000000, -70.000000, 0.000000);
	bpv__StaticMesh__pf->RelativeRotation = FRotator(0.000000, -10.000031, 0.000000);
...
TEXT("NSLOCTEXT(\"[5BB943BE467269CA343FD498E788629B]\", \"E8F302EC452F554C7FB7D9966CFB6513\", \"FishingRod\")")	);
	bpv__FishingRodStruct__pf.bpv__Item_2_62BAB36C42C7C677530F17B8E558FF3A__pf.bpv__Texture_15_7F6B4FA54855A03EC62974BC9E749329__pf = CastChecked<UTexture2D>(CastChecked<UDynamicClass>(AFishingPlace_C__pf1097354743::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	...
	bpv__FishingRodStruct__pf.bpv__Item_2_62BAB36C42C7C677530F17B8E558FF3A__pf.bpv__Class_12_33456D674F08300E4B2C238A1C0A44C6__pf = CastChecked<UClass>(CastChecked<UDynamicClass>(AFishingPlace_C__pf1097354743::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
...
TEXT("NSLOCTEXT(\"[5BB943BE467269CA343FD498E788629B]\", \"82D30CB246A36A71739A0284D481EC75\", \"Fish\")")	);
	bpv__FishStruct__pf.bpv__Item_2_62BAB36C42C7C677530F17B8E558FF3A__pf.bpv__Texture_15_7F6B4FA54855A03EC62974BC9E749329__pf = CastChecked<UTexture2D>(CastChecked<UDynamicClass>(AFishingPlace_C__pf1097354743::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	...
	bpv__FishStruct__pf.bpv__Item_2_62BAB36C42C7C677530F17B8E558FF3A__pf.bpv__Class_12_33456D674F08300E4B2C238A1C0A44C6__pf = CastChecked<UClass>(CastChecked<UDynamicClass>(AFishingPlace_C__pf1097354743::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
	bpv__FishStruct__pf.bpv__Quantity_5_0523A9EE43EB25B1CD4325BF1F14AE32__pf = 1;
}
PRAGMA_ENABLE_OPTIMIZATION
void AFishingPlace_C__pf1097354743::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void AFishingPlace_C__pf1097354743::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void AFishingPlace_C__pf1097354743::bpf__ExecuteUbergraph_FishingPlace__pf_0(int32 bpp__EntryPoint__pf)
{
...
TEXT("NSLOCTEXT(\"[5BB943BE467269CA343FD498E788629B]\", \"342F546E4F7DD0CDE314038FDA5698D4\", \"Fish x1 obtained!\")")	));
				}
			}
		case 3:
			{
				if(::IsValid(b1l__K2Node_DynamicCast_AsTop_Down_Controller1__pf))
				{
					b1l__K2Node_DynamicCast_AsTop_Down_Controller1__pf->bpv__MinClickDistance__pf = 120.000000;
				}
			}
		case 4:
			{
				...
				{
					bpv__InventoryComp__pf->bpf__AddToInventory__pf(bpv__FishStruct__pf, /*out*/ b1l__CallFunc_AddToInventory_Success__pf);
				}
			}
		case 5:
			{
		...
		case 7:
			{
				UKismetSystemLibrary::Delay(this, 2.000000, FLatentActionInfo(8, 1199664870, TEXT("ExecuteUbergraph_FishingPlace_0"), this));
				__CurrentState = -1;
				break;
			}
		case 8:
		...
		case 12:
			{
				UKismetSystemLibrary::Delay(this, 3.000000, FLatentActionInfo(1, 1626600049, TEXT("ExecuteUbergraph_FishingPlace_0"), this));
				__CurrentState = -1;
				break;
			}
		case 13:
			{
				b1l__K2Node_DynamicCast_AsTop_Down_Controller__pf = Cast<ATopDownController_C__pf3669546605>(bpv__CharController__pf);
				b1l__K2Node_DynamicCast_bSuccess__pf = (b1l__K2Node_DynamicCast_AsTop_Down_Controller__pf != nullptr);;
...
TEXT("NSLOCTEXT(\"[5BB943BE467269CA343FD498E788629B]\", \"0612AE8449DA0ABF14463287043D342F\", \"Fishing Rod required\")")	));
				}
			}
		case 15:
			{
				UKismetSystemLibrary::Delay(this, 2.000000, FLatentActionInfo(10, 594748082, TEXT("ExecuteUbergraph_FishingPlace_0"), this));
				__CurrentState = -1;
				break;
			}
		case 16:
			{
				b1l__K2Node_DynamicCast_AsTop_Down_Controller1__pf = Cast<ATopDownController_C__pf3669546605>(bpv__CharController__pf);
				b1l__K2Node_DynamicCast_bSuccess1__pf = (b1l__K2Node_DynamicCast_AsTop_Down_Controller1__pf != nullptr);;
		...
		case 17:
			{
				if(::IsValid(b1l__K2Node_DynamicCast_AsTop_Down_Controller1__pf))
				{
					b1l__K2Node_DynamicCast_AsTop_Down_Controller1__pf->StopMovement();
				}
			}
		case 18:
			{
				if(::IsValid(b1l__K2Node_DynamicCast_AsTop_Down_Controller1__pf))
				{
					b1l__K2Node_DynamicCast_AsTop_Down_Controller1__pf->bpv__MinClickDistance__pf = 100000.000000;
				}
			}
		case 19:
			{
				...
				{
					b1l__K2Node_DynamicCast_AsTop_Down_Controller1__pf->bpv__HUDWidget__pf->bpf__SetText__pf(FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[5BB943BE467269CA343FD498E788629B]\", \"A7392FD447C8874207038A97E623DA0A\", \"Fishing...\")")	));
				}
				__CurrentState = 12;
				break;
			}
		...
		case 21:
			{
				...
				b1l__K2Node_DynamicCast_bSuccess2__pf = (b1l__K2Node_DynamicCast_AsTop_Down_Character__pf != nullptr);;
		...
		case 22:
			{
				bpv__CharRef__pf = b1l__K2Node_DynamicCast_AsTop_Down_Character__pf;
			}
		case 23:
			{
				if(::IsValid(b1l__K2Node_DynamicCast_AsTop_Down_Character__pf))
				{
					bpfv__CallFunc_GetController_ReturnValue__pf = b1l__K2Node_DynamicCast_AsTop_Down_Character__pf->APawn::GetController();
				}
				bpv__CharController__pf = bpfv__CallFunc_GetController_ReturnValue__pf;
			}
		case 24:
			{
				UInventoryComponent_C__pf2577010357*  __Local__9 = ((UInventoryComponent_C__pf2577010357*)nullptr);
				bpv__InventoryComp__pf = ((::IsValid(b1l__K2Node_DynamicCast_AsTop_Down_Character__pf)) ? (b1l__K2Node_DynamicCast_AsTop_Down_Character__pf->bpv__InventoryComponent__pf) : (__Local__9));
			}
		case 25:
			{
				TArray<FSlotStruct__pf697489738>  __Local__10 = {};
				bpv__Inventory__pf = ((::IsValid(b1l__K2Node_DynamicCast_AsTop_Down_Character__pf) && ::IsValid(b1l__K2Node_DynamicCast_AsTop_Down_Character__pf->bpv__InventoryComponent__pf)) ? (b1l__K2Node_DynamicCast_AsTop_Down_Character__pf->bpv__InventoryComponent__pf->bpv__Inventory__pf) : (__Local__10));
			}
		case 26:
			{
				TArray<FSlotStruct__pf697489738>  __Local__11 = {};
				bpfv__CallFunc_Array_Find_ReturnValue__pf = FCustomThunkTemplates::Array_Find(((::IsValid(b1l__K2Node_DynamicCast_AsTop_Down_Character__pf) && ::IsValid(b1l__K2Node_DynamicCast_AsTop_Down_Character__pf->bpv__InventoryComponent__pf)) ? (b1l__K2Node_DynamicCast_AsTop_Down_Character__pf->bpv__InventoryComponent__pf->bpv__Inventory__pf) : (__Local__11)), bpv__FishingRodStruct__pf);
				bpfv__CallFunc_Greater_IntInt_ReturnValue__pf = UKismetMathLibrary::Greater_IntInt(bpfv__CallFunc_Array_Find_ReturnValue__pf, -1);
...
void AFishingPlace_C__pf1097354743::bpf__Interact__pf(AActor* bpp__Interactor__pf)
{
	b1l__K2Node_Event_Interactor__pf = bpp__Interactor__pf;
	bpf__ExecuteUbergraph_FishingPlace__pf_0(20);
}
PRAGMA_DISABLE_OPTIMIZATION
void AFishingPlace_C__pf1097354743::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AFishingPlace_C__pf1097354743::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AFishingPlace_C__pf1097354743
{
	FRegisterHelper__AFishingPlace_C__pf1097354743()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/TopDownBP/Blueprints/InventoryLogic/Builds/FishingPlace"), &AFishingPlace_C__pf1097354743::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AFishingPlace_C__pf1097354743 Instance;
};
FRegisterHelper__AFishingPlace_C__pf1097354743 FRegisterHelper__AFishingPlace_C__pf1097354743::Instance;
